...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 13, 2021 lúc 03:19 PM
...
--
-- Cơ sở dữ liệu: `dbtechjob`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `candidate_apply`
--
...
--
-- Đang đổ dữ liệu cho bảng `candidate_apply`
--
...
(6, 'Hiếu Quốc', 'FPT Software', NULL, '2021-02-20 00:00:00', '2021-02-19 00:00:00'),
...
--
-- Cấu trúc bảng cho bảng `follow_companies`
--
...
(25, 'Technical Leader – Up to $3000', 'hr@fpt.com', '1615635454.jpg', '<h4>CÁC PHÚC LỢI DÀNH CHO BẠN</h4><p>Salary review on the excellent performance</p><p>Annual Summer Vacation: follows the company’s policy and starts from May every year</p><p>International, dynamic, friendly working environment</p><h4>MÔ TẢ CÔNG VIỆC</h4><p>_ Ít nhất 10 năm kinh nghiệm trong lĩnh vực software</p><p>_ 5 năm làm vị trí SA</p><p>_ Nắm rõ các kiến thức nền tảng với các layer từ Hardware =&gt; OS =&gt; Infra =&gt; Application System, Middleware =&gt; Application</p><p>_ Nắm rõ cách thức hoạt ', 45, 6, '2500', '3000', '$', 8.00, 'Da Nang', '2021-11-28 00:00:00', '48', '2021-03-13 00:00:00', '2021-03-13 00:00:00', 26, b'1'),
(37, 'Embedded Software Engineer (C/C++, Autosar, Bsw) – Up to 2000 ', 'quochieuu@gmail.com', '1615636152.jpg', '<p>CÁC PHÚC LỢI DÀNH CHO BẠN</p><p>Lương tháng 13, thưởng dự án hàng tháng, thưởng kỳ nghĩ hàng năm, bảo hiểm từ FPT Care</p><p>Tăng lương và cấp bậc theo kì kiểm tra năng lực hàng năm</p><p>Có cơ hội đi onsite tại Singapore, Malaysia, Mỹ, Nhật Bản, châu Âu…;</p><p>MÔ TẢ CÔNG VIỆC</p><p>• You will take part in multi-million project for high-profile customer, which are automotive industry</p><p>• You will design solution for embedded software used in a car such as AUTOSAR software.</p><p>• You have a great career advance to expand your horizon not only in automotive industry but also the international working experience.</p><p>• You will work with the team to design, implement and verify software based on AUTOSAR architecture and methodology.</p><p>• BSW development. Phase 1: Diagnostic module design and demo DID</p><p><br></p><p>Quantity : 20</p><p>Position type : Full time</p><p>YÊU CẦU CÔNG VIỆC</p><p>• At least 2 years’ experience in programming in C, Embedded system development</p><p>• 2 or more years of experience in the development, configuration, or testing of any of the follo', 3, 3, '1000', '1500', '$', 8.00, 'K382/H31/10 NÚI THÀNH, ĐÀ NẴNG', '2021-03-26 00:00:00', '48', '2021-03-13 00:00:00', '2021-03-13 00:00:00', 26, b'1'),
...
--
-- Đang đổ dữ liệu cho bảng `job_career`
--
...
--
-- Cấu trúc bảng cho bảng `messages_from_employers`
--
...
--
-- Cấu trúc bảng cho bảng `report_post_comment`
--
...
--
-- Cấu trúc bảng cho bảng `save_jobs`
--
...
(12, 'admin@gmail.com', '202cb962ac59075b964b07152d234b70', 3, '0983058005', 'Admin', 'Hiếu', 'Hiếu Admin', '1970-01-01 00:00:00', b'0', 'Đà Nẵng', '1615640620.png', b'1'),
(26, 'hr1@gmail.com', '202cb962ac59075b964b07152d234b70', 2, NULL, 'Tran', 'Chi', 'Chi Tran', NULL, NULL, NULL, '1615631543.png', b'1'),
(27, 'hr2@gmail.com', '202cb962ac59075b964b07152d234b70', 2, NULL, 'Hieu', 'Le', 'Le Hieu', NULL, NULL, NULL, '1615632029.png', b'1'),
(28, 'user1@gmail.com', '202cb962ac59075b964b07152d234b70', 1, '0983058005', 'Duc', 'Hien', 'Hien Duc', NULL, NULL, NULL, '1615632262.png', b'1'),
(29, 'user2@gmail.com', '202cb962ac59075b964b07152d234b70', 1, '0988058555', 'Duc', 'Hung', 'Hung Duc', NULL, NULL, NULL, '1615632396.png', b'1'),
(30, 'hr3@gmail.com', '202cb962ac59075b964b07152d234b70', 2, NULL, 'Duc', 'Hien', 'Hien Duc', NULL, NULL, NULL, '1615638220.png', b'1');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `user_company`
--
...
--
-- Đang đổ dữ liệu cho bảng `user_company`
--
...
(11, 'Luxoft', NULL, '1615638230.jpg', NULL, 'Ngũ Hành Sơn, Đà Nẵng', NULL, NULL, '48', 'Hien Hoang', b'1', 30);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `user_experiences`
--
...
--
-- Chỉ mục cho bảng `candidate_apply`
--
...
--
-- Chỉ mục cho bảng `follow_companies`
--
...
--
-- Chỉ mục cho bảng `messages_from_employers`
--
...
--
-- Chỉ mục cho bảng `report_post_comment`
--
...
--
-- Chỉ mục cho bảng `user_experiences`
--
...
--
-- AUTO_INCREMENT cho bảng `candidate_apply`
--
ALTER TABLE `candidate_apply`
...
--
-- AUTO_INCREMENT cho bảng `follow_companies`
--
ALTER TABLE `follow_companies`
...
--
-- AUTO_INCREMENT cho bảng `job_career`
--
ALTER TABLE `job_career`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT cho bảng `messages_from_employers`
--
ALTER TABLE `messages_from_employers`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT cho bảng `report_post_comment`
--
ALTER TABLE `report_post_comment`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT cho bảng `save_jobs`
--
ALTER TABLE `save_jobs`
...
--
-- AUTO_INCREMENT cho bảng `user_company`
--
ALTER TABLE `user_company`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `user_experiences`
--
ALTER TABLE `user_experiences`
...
--
-- Các ràng buộc cho bảng `candidate_apply`
--
ALTER TABLE `candidate_apply`
...
--
-- Các ràng buộc cho bảng `follow_companies`
--
ALTER TABLE `follow_companies`
...
--
-- Các ràng buộc cho bảng `job_career`
--
ALTER TABLE `job_career`
...
--
-- Các ràng buộc cho bảng `messages_from_employers`
--
ALTER TABLE `messages_from_employers`
...
--
-- Các ràng buộc cho bảng `report_post_comment`
--
ALTER TABLE `report_post_comment`
...
--
-- Các ràng buộc cho bảng `save_jobs`
--
ALTER TABLE `save_jobs`
...
--
-- Các ràng buộc cho bảng `user_company`
--
ALTER TABLE `user_company`
  ADD CONSTRAINT `user_company_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Các ràng buộc cho bảng `user_experiences`
--
ALTER TABLE `user_experiences`
